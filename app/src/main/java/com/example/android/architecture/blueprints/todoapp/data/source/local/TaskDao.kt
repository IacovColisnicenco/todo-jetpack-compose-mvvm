...
interface TaskDao {
     ...
     * This method returns a Flow of a list of LocalTask objects,
     * allowing for observing changes in the list of tasks over time.
    ...
    @Query("UPDATE task SET `order` = :order WHERE id = :taskId")
